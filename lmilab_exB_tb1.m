...
myfile{1}='github\caseB\lmilab_exB_SOFS_L2N_Nd=5_Nl=7_PhiD=100_gL2=1000.mat';
myfile{2}='github\caseB\lmilab_exB_SOFS_L2N_Nd=5_Nl=7_PhiD=100_gL2=100.mat';
myfile{3}='github\caseB\lmilab_exB_SOFS_L2N_Nd=5_Nl=7_PhiD=100_gL2=10.mat';
myfile{4}='github\caseB\lmilab_exB_SOFS_L2N_Nd=5_Nl=7_PhiD=100_gL2=1.mat';
...
rlt(Nrlt+1).TW.PI.info=stepinfo_caseB(KPpi,KIpi,[],[],ss(A_pi,[Bu_pi,Bw_pi],Cy_pi,0),t,[yf;dw],'PI');
end
...
rlt(Nrlt+1).TW.PID.info=stepinfo_caseB(KPpid,KIpid,KDpid,PhiD,ss(A_pid,[Bu_pid,Bw_pid],Cy_pid,0),t,[yf;dw],'PID');
end
