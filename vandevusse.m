function [sys,x0,str,ts,simStateCompliance]=vandevusse(t,x,u,flag,x0,par)
...
%
%[sys,x0,str,ts,simStateCompliance]=vandevusse(t,x,u,flag,x0,par)
%
...
%----- S-FUNCTION BUILDING PARAMETERS AND INITIAL CONDITIONS --------
    case 0,        
sys(1)=4;	%Number of continuous states
